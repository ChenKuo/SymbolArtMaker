<template>
    <svg id="colorpicker" :width="size" :height="size" viewBox="-1 -1 2 2" transform="scale(1,-1)">
        <defs>
            <pattern id="sat-lum-mask" patternUnits="userSpaceOnUse"  x="0.95" y="1" width="1.9" height="1.5">
                <image :href="satLumMask" x="0" y="0" width="1.9" height="1.5" preserveAspectRatio="none"/>
            </pattern>
            <pattern id="hue-pattern" patternUnits="userSpaceOnUse" x="1" y="1" width="2" height="2">
